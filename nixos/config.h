...
/* commands */
static char dmenumon[2] = "0"; /* Required by vxwm.c */
static const char *dmenucmd[]   = { "dmenu_run", "-m", dmenumon, NULL };
static const char *qslauncher[] = { "sh", "-c", "quickshell ipc call launcher toggle", NULL };
static const char *wppicker[]   = { "sh", "-c", "quickshell ipc call wallpaper toggle", NULL };
...
#if ZOOM
static const char *zoomin[] = { "vcompmgr", "-Z", "+0.15", NULL };
static const char *zoomout[] = { "vcompmgr", "-Z", "-0.15", NULL };
static const char *zoomreset[] = { "vcompmgr", "-Z", "1", NULL };
#endif

static const Key keys[] = {
        /* modifier                     key        function        argument */
        { MODKEY,                       XK_p,      spawn,          {.v = qslauncher } },
        { MODKEY,                       XK_w,      spawn,          {.v = wppicker } },
